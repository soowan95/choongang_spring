...
SELECT *
FROM my_table42_a a
         JOIN my_table43_b b ON a.col1 = b.col1;

SELECT *
FROM my_table42_a a
         LEFT JOIN my_table43_b b ON a.col1 = b.col1;

SELECT *
FROM my_table42_a a
         RIGHT JOIN my_table43_b b ON a.col1 = b.col1;
...
SELECT *
FROM my_table44_a a
         JOIN my_table45_b b ON a.col1 = b.col1;
